      ...
      <article id="welcome" className="row">
        <div className="content col">
          ...
          <h1 className="typewriter">
            We build better brands on the Blockchain
          </h1>
          <p>
            We are Ember. A hybrid, blockchain experience agency crafting
            brands, websites, marketing strategies, products, and pretty much
            anything you can imagine in the "cryptosphere." Our mission is to
