      ...
      <article id="elements">
        ...
        <div className="row">
          <div className="content col">
            ...
            <p>
              <strong>Ember is "agency first; product second."</strong> This
              means that the core of our business isn't built on a product that
              will fluctuate based on global social, economic, or market
              conditions. Those elements have very little influence on our core
              business foundation and that's what promotes an infinite lifecycle
              for Ember. Our Construct is driven by a cyclical triad of
              advisory, consulting, and product.
            </p>
            <p>
              The <span className="blue">Advisory</span> is the oxygen we
              breathe into every project.
              <br />
